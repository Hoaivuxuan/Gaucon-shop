...
class Account extends Component {
  ...
  async componentDidMount() {
    if (this.props.userInfo && this.props.userInfo.id) {
      console.log("check id: ", this.props.userInfo.id);
      let response = await getUsers(this.props.userInfo.id);
            ...
            <div className="row">
                ...
                <div className="block-account">
                  ...
                  <ul>
                    ...
                    <div>
                      ...
                      <a className="title-info" href="/cart">
                        Đơn hàng của tôi
                      </a>
                    </div>
                    <div>
              ...
              <div className="col-right-ac">
                ...
                <div className="form-signup name-account m992">
                  <p>
                    <strong>Họ và tên:</strong> {arrUsers.name}
                  </p>
                  <p>
                    <strong>Địa chỉ email:</strong> {arrUsers.email}
                  </p>
                  <p>
                    {" "}
                    <strong>Điện thoại:</strong> {arrUsers.phonenumber}{" "}
                  </p>
                  <p>
                    <strong>Địa chỉ:</strong> {arrUsers.address}
                  </p>
                </div>
              </div>
            </div>
